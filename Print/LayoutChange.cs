...
namespace 지니_64
{
    public class LayoutChange
    {
        public static void CBB_layout_SelectedIndexChanged(object sender)
        {
            ...
            if (Form1.form1.CBB_layout.SelectedIndex == 3 || Form1.form1.CBB_layout.SelectedIndex == 4)
            {
            ...
            else if (Form1.form1.CBB_layout.SelectedIndex == 6)
            {
        ...
        public static void CBB_layout_SelectedIndex(int index)
        {
            ...
            Form1.form1.tab_잔고.TabPages[0].Controls.Remove(Form1.form1.LB_주문내역);
            ...
            if (Form1.form1.tab_체결.TabPages.Count == 1)
            {
                ...
                Form1.form1.tab_체결.TabPages[1].Controls.Add(Form1.form1.종목감추기_로그);
            ...
            if (Form1.form1.tab_주문.SelectedIndex == 0)
            {
                Form1.form1.L_주문row.Show();
                Form1.form1.TB_주문row.Show();
                Form1.form1.L_주문row.BringToFront();
            ...
            if (index == 6)
            {
                ...
                Form1.form1.tab_주문.TabPages[0].Controls.Remove(Form_JuMun.form.JuMun_dataGridView);
                Form1.form1.panel_주문.Controls.Remove(Form1.form1.LB_주문내역);
                Form1.form1.panel_주문.Controls.Remove(Form1.form1.L_주문row);
                Form1.form1.panel_주문.Controls.Remove(Form1.form1.TB_주문row);
                Form1.form1.panel_주문.Controls.Remove(Form_JuMun.form.종목감추기_주문);
                Form1.form1.tab_잔고.TabPages[0].Controls.Add(Form_JuMun.form.JuMun_dataGridView);
                Form1.form1.tab_잔고.TabPages[0].Controls.Add(Form1.form1.LB_주문내역);
                Form1.form1.tab_잔고.TabPages[0].Controls.Add(Form1.form1.L_주문row);
                Form1.form1.tab_잔고.TabPages[0].Controls.Add(Form1.form1.TB_주문row);
                Form1.form1.tab_잔고.TabPages[0].Controls.Add(Form_JuMun.form.종목감추기_주문);

                Form1.form1.tab_잔고.TabPages[0].Controls.Add(Form1.form1.LB_주문내역);
                Form1.form1.LB_주문내역.BringToFront();

                Form1.form1.LB_주문내역.Location = new Point(-1, 286);
                Form1.form1.L_주문row.Location = new Point(88, 286);
            ...
            else
            {
                if (!Form1.form1.tab_주문.TabPages[0].ToString().Contains("주문 내역"))
                {
                    ...
                    Form1.form1.tab_잔고.TabPages[0].Controls.Remove(Form_JuMun.form.JuMun_dataGridView);
                    Form1.form1.tab_잔고.TabPages[0].Controls.Remove(Form1.form1.LB_주문내역);
                    Form1.form1.tab_잔고.TabPages[0].Controls.Remove(Form1.form1.L_주문row);
                    Form1.form1.tab_잔고.TabPages[0].Controls.Remove(Form1.form1.TB_주문row);
                    Form1.form1.tab_잔고.TabPages[0].Controls.Remove(Form_JuMun.form.종목감추기_주문);
                    Form1.form1.tab_주문.TabPages[0].Controls.Add(Form_JuMun.form.JuMun_dataGridView);
                    Form1.form1.panel_주문.Controls.Add(Form1.form1.L_주문row);
                    Form1.form1.panel_주문.Controls.Add(Form1.form1.TB_주문row);
                    Form1.form1.tab_주문.TabPages[0].Controls.Add(Form_JuMun.form.종목감추기_주문);

                    Form1.form1.tab_주문.SelectedIndex = 0;
                }
            }
            ...
            if (index == -1)
            {
                Form1.form1.panel_잔고.Location = new Point(-1, 139);
                Form1.form1.panel_잔고.Size = new Size(1103, 538);
                Form1.form1.tab_잔고.Location = new Point(-5, -3);
                Form1.form1.tab_잔고.Size = new Size(1111, 544);
                Form1.form1.JanGo_dataGridView.Location = new Point(-3, -2);
                Form1.form1.JanGo_dataGridView.Size = new Size(1106, 520);
                Form1.form1.종목감추기_잔고.Location = new Point(185, 17);
                ...
                //주문패널
                Form1.form1.panel_주문.Location = new Point(1101, 20);
                Form1.form1.panel_주문.Size = new Size(820, 333);
                ...
                Form1.form1.L_주문row.Location = new Point(586, -1);
                ...
                Form_Outstanding.form.종목감추기_미체결.Location = new Point(167, 38);
                ...
                Form1.form1.L_체결row.Location = new Point(153, 0);
                ...
                if (Form1.form1.tab_주문.TabPages.Count < 6)
                {
                    ...
                    myTabPage.Controls.Add(Form1.form1.panel_TEST_A);

                    myTabPage = new TabPage("조건식TEST B");
                    myTabPage.BackColor = SystemColors.ControlLight;
                    myTabPage.BorderStyle = BorderStyle.FixedSingle;
                    Form1.form1.tab_주문.TabPages.Add(myTabPage);
                    myTabPage.Controls.Add(Form1.form1.panel_TEST_B);

                    myTabPage = new TabPage("조건식TEST C");
                    myTabPage.BackColor = SystemColors.ControlLight;
                    myTabPage.BorderStyle = BorderStyle.FixedSingle;
                    Form1.form1.tab_주문.TabPages.Add(myTabPage);
                    myTabPage.Controls.Add(Form1.form1.panel_TEST_C);

                    myTabPage = new TabPage("조건식TEST D");
                    myTabPage.BackColor = SystemColors.ControlLight;
                    myTabPage.BorderStyle = BorderStyle.FixedSingle;
                    Form1.form1.tab_주문.TabPages.Add(myTabPage);
                    myTabPage.Controls.Add(Form1.form1.panel_TEST_D);
                }
                ...
                Form1.form1.BT_watch_Save_A.Show();
                Form1.form1.BT_watch_Save_B.Show();
                Form1.form1.BT_watch_Save_C.Show();
                Form1.form1.BT_watch_Save_D.Show();
            ...
            if (index == 0)
            {
                ...
                //주문패널
                Form1.form1.panel_주문.Location = new Point(1101, 20);
                Form1.form1.panel_주문.Size = new Size(820, 657);
                Form1.form1.tab_주문.Location = new Point(-5, -3);
                ...
                Form1.form1.L_주문row.Location = new Point(463, -1);
                Form1.form1.TB_주문row.Location = new Point(552, -1);
                Form1.form1.최종매입가View.Size = new Size(825, 641);
                ...
                Form1.form1.L_체결row.Location = new Point(153, -1);
                ...
                Form1.form1.BT_watch_Save_A.Show();
                Form1.form1.BT_watch_Save_B.Hide();
                Form1.form1.BT_watch_Save_C.Show();
                Form1.form1.BT_watch_Save_D.Hide();
            ...
            else if (index == 1)
            {
                ...
                //잔고패널
                Form1.form1.panel_잔고.Location = new Point(-1, 139);
                Form1.form1.panel_잔고.Size = new Size(1103, 879);
                Form1.form1.tab_잔고.Location = new Point(-5, -3);
            ...
            else if (index == 3)
            {
                ...
                Form1.form1.L_주문row.Location = new Point(304, -1);
                ...
                TabPage myTabPage = new TabPage("조건식 TEST");
                myTabPage.BackColor = SystemColors.ControlLight;
                myTabPage.BorderStyle = BorderStyle.FixedSingle;
                Form1.form1.tab_주문.TabPages.Add(myTabPage);
                myTabPage.Controls.Add(Form1.form1.panel_TEST_A);
                ...
                Form1.form1.panel_TEST_A.BringToFront();
                Form1.form1.panel_TEST_B.BringToFront();
                Form1.form1.panel_TEST_C.BringToFront();
                Form1.form1.panel_TEST_D.BringToFront();

                Form1.form1.BT_watch_Save_B.Hide();
                Form1.form1.BT_watch_Save_C.Hide();
                Form1.form1.BT_watch_Save_D.Hide();
            }
            else if (index == 4)
            {
                ...
                //잔고패널
                Form1.form1.panel_잔고.Location = new Point(-1, 139);
                Form1.form1.panel_잔고.Size = new Size(1922, 611);
                Form1.form1.tab_잔고.Location = new Point(-5, -3);
                ...
                Form1.form1.Controls.Add(Form1.form1.종목감추기_로그);
                ...
                Form1.form1.종목감추기_로그.Location = new Point(1206, 14);
                ...
                //주문패널
                Form1.form1.panel_주문.Location = new Point(-1, 746);
                Form1.form1.panel_주문.Size = new Size(820, 272);
                Form1.form1.tab_주문.Location = new Point(-5, -3);
                ...
                Form_JuMun.form.종목감추기_주문.Location = new Point(148, 18);
                Form_JuMun.form.종목감추기_주문.Size = new Size(96, 215);
                Form1.form1.L_주문row.Location = new Point(586, -1);
                Form1.form1.TB_주문row.Location = new Point(675, -1);
                Form_JuMun.form.BringToFront();
            ...
            else if (index == 5)
            {
                ...
                //주문패널
                Form1.form1.panel_주문.Location = new Point(-1, 676);
                Form1.form1.panel_주문.Size = new Size(820, 341);
                Form1.form1.tab_주문.Location = new Point(-5, -3);
            ...
            else if (index == 6)
            {
                ...
                //잔고패널
                Form1.form1.panel_잔고.Location = new Point(-1, 139);
                Form1.form1.panel_잔고.Size = new Size(1103, 591);
                Form1.form1.tab_잔고.Location = new Point(-5, -3);
                ...
                //주문패널
                Form1.form1.panel_주문.Location = new Point(1101, 20);
                Form1.form1.panel_주문.Size = new Size(820, 710);
                Form1.form1.tab_주문.Location = new Point(-5, -3);
        ...
        public static void CB_기능설정_CheckedChanged(object sender)
        {
            ...
            if (CB.Checked)
            {
                if (!sender.Equals(Form1.form1.CB_기본매매)) if (Form1.FormBasic_Open) { Form_Basic.form.Close(); }
                if (!sender.Equals(Form1.form1.CB_반복매매)) if (Form1.FormRepeat_Open) { Form_Repeat.form.Close(); }
                if (!sender.Equals(Form1.form1.CB_계좌관리)) if (Form1.FormAccountManagement_Open) { Form_AccountManagement.form.Close(); }
                if (!sender.Equals(Form1.form1.CB_특수매매)) if (Form1.FormSpecial_Open) { Form_Special.form.Close(); }
                if (!sender.Equals(Form1.form1.CB_대금탐색)) if (Form1.FormPriceSearch_Open) { Form_PriceSearch.form.Close(); }
                if (!sender.Equals(Form1.form1.CB_매매그룹)) if (Form1.FormTradeGroup_Open) { Form_TradeGroup.form.Close(); }
                if (!sender.Equals(Form1.form1.CB_기능설정)) if (Form1.FormFunction_Open) { Form_Function.form.Close(); }
                if (!sender.Equals(Form1.form1.CB_Jisu_avgset)) if (Form1.FormJisu_Open) { Form1.form1.CB_Jisu_avgset.Checked = false; }
            }
            else
            {
                CBB_layout_SelectedIndex(Form1.form1.CBB_layout.SelectedIndex);
            }
            ...
            if (sender.Equals(Form1.form1.CB_Jisu_avgset))
            {
                if (CB.Checked)
                {
            ...
            if (sender.Equals(Form1.form1.CB_기본매매))
            {
                if (CB.Checked)
                {
                    ...
                    Form_Basic.form.CB_기본매매_시작위치저장.Checked = Properties.Settings.Default.CB_기본매매_시작위치저장;
                    if (Properties.Settings.Default.CB_기본매매_시작위치저장) startpoint = Properties.Settings.Default.WindowLocation;
                    Form_Basic.form.Location = startpoint;
                    StartLocationChanged(Form_Basic.form, X, Y);
                    Form_Basic.form.Show();

                    Form_Basic.form.CB_레이아웃고정_기본매매.Checked = Properties.Settings.Default.CB_레이아웃고정_기본매매;
                    if (!Form_Basic.form.CB_레이아웃고정_기본매매.Checked) CBB_layout_SelectedIndex(-1);
                    else CBB_layout_SelectedIndex(Form1.form1.CBB_layout.SelectedIndex);

                    Form1.FormBasic_Open = true;
                }
                else
                {
                    Properties.Settings.Default.CB_레이아웃고정_기본매매 = Form_Basic.form.CB_레이아웃고정_기본매매.Checked;
                    Properties.Settings.Default.CB_기본매매_시작위치저장 = Form_Basic.form.CB_기본매매_시작위치저장.Checked;
                    if (Properties.Settings.Default.CB_기본매매_시작위치저장) Properties.Settings.Default.WindowLocation = Form_Basic.form.Location;
                    Form1.FormBasic_Open = false;
                    Form_Basic.form.Close();
                }
            }
            ...
            if (sender.Equals(Form1.form1.CB_반복매매))
            {
                if (CB.Checked)
                {
                    ...
                    Form_Repeat.form.CB_반복매매_시작위치저장.Checked = Properties.Settings.Default.CB_반복매매_시작위치저장;
                    if (Properties.Settings.Default.CB_반복매매_시작위치저장) startpoint = Properties.Settings.Default.WindowLocation;
                    Form_Repeat.form.Location = startpoint;
                    StartLocationChanged(Form_Repeat.form, X, Y);
                    Form_Repeat.form.Show();

                    Form_Repeat.form.CB_레이아웃고정_반복매매.Checked = Properties.Settings.Default.CB_레이아웃고정_반복매매;
                ...
                {
                    Properties.Settings.Default.CB_레이아웃고정_반복매매 = Form_Repeat.form.CB_레이아웃고정_반복매매.Checked;
                    Properties.Settings.Default.CB_반복매매_시작위치저장 = Form_Repeat.form.CB_반복매매_시작위치저장.Checked;
                    if (Properties.Settings.Default.CB_반복매매_시작위치저장) Properties.Settings.Default.WindowLocation = Form_Repeat.form.Location;
                    Form1.FormRepeat_Open = false;
                    Form_Repeat.form.Close();
                }
            }
            ...
            if (sender.Equals(Form1.form1.CB_계좌관리))
            {
                if (CB.Checked)
                {
                    ...
                    Form_AccountManagement.form.CB_계좌관리_시작위치저장.Checked = Properties.Settings.Default.CB_계좌관리_시작위치저장;
                    if (Properties.Settings.Default.CB_계좌관리_시작위치저장) startpoint = Properties.Settings.Default.WindowLocation;
                    ...
                    Form_AccountManagement.form.CB_레이아웃고정_계좌관리.Checked = Properties.Settings.Default.CB_레이아웃고정_계좌관리;
                ...
                {
                    Properties.Settings.Default.CB_레이아웃고정_계좌관리 = Form_AccountManagement.form.CB_레이아웃고정_계좌관리.Checked;
                    Properties.Settings.Default.CB_계좌관리_시작위치저장 = Form_AccountManagement.form.CB_계좌관리_시작위치저장.Checked;
                    if (Properties.Settings.Default.CB_계좌관리_시작위치저장) Properties.Settings.Default.WindowLocation = Form_AccountManagement.form.Location;
                    Form1.FormAccountManagement_Open = false;
                    Form_AccountManagement.form.Close();
                }
            }
            ...
            if (sender.Equals(Form1.form1.CB_특수매매))
            {
                if (CB.Checked)
                {
                    ...
                    Form_Special.form.CB_특수매매_시작위치저장.Checked = Properties.Settings.Default.CB_특수매매_시작위치저장;
                    if (Properties.Settings.Default.CB_특수매매_시작위치저장) startpoint = Properties.Settings.Default.WindowLocation;
                    Form_Special.form.Location = startpoint;
                    StartLocationChanged(Form_Special.form, X, Y);
                    Form_Special.form.Show();

                    Form_Special.form.CB_레이아웃고정_특수매매.Checked = Properties.Settings.Default.CB_레이아웃고정_특수매매;
                ...
                else
                {
                    try
                    {
                        Properties.Settings.Default.CB_수동주문_시장가 = Form_Special.form.CB_수동주문_시장가.Checked;
                        Properties.Settings.Default.CB_수동주문_주문가고정 = Form_Special.form.CB_수동주문_주문가고정.Checked;
                        Properties.Settings.Default.수동주문_RB_매수 = Form_Special.form.RB_매수.Checked;
                        ...
                        Properties.Settings.Default.TB_수동주문_tick = TB_수동주문_tick;
                        Properties.Settings.Default.MTB_수동주문_repeat = MTB_수동주문_repeat;
                        Properties.Settings.Default.MTB_수동주문_cansel_time = MTB_수동주문_cansel_time;
                        Properties.Settings.Default.TB_수동주문_ratio = TB_수동주문_ratio;
                        Properties.Settings.Default.TB_수동주문_주문비 = TB_수동주문_주문비;
                        ...
                        Properties.Settings.Default.combo_수동주문_choice = Form_Special.form.combo_수동주문_choice.SelectedIndex;
                    }
                    catch (Exception e)
                    {
                        Console.WriteLine("특수매매_저장 수동주문입력 에러: " + e.Message); Form1.Error_Log("특수매매_저장 수동주문입력 에러: " + e.Message);
                    }

                    Properties.Settings.Default.CB_레이아웃고정_특수매매 = Form_Special.form.CB_레이아웃고정_특수매매.Checked;
                    Properties.Settings.Default.CB_특수매매_시작위치저장 = Form_Special.form.CB_특수매매_시작위치저장.Checked;
                    if (Properties.Settings.Default.CB_특수매매_시작위치저장) Properties.Settings.Default.WindowLocation = Form_Special.form.Location;
                    Form1.FormSpecial_Open = false;
                    Form_Special.form.Close();
                }
            }
            ...
            if (sender.Equals(Form1.form1.CB_대금탐색))
            {
                if (CB.Checked)
                {
                    ...
                    Form_PriceSearch.form.CB_대금탐색_시작위치저장.Checked = Properties.Settings.Default.CB_대금탐색_시작위치저장;
                    if (Properties.Settings.Default.CB_대금탐색_시작위치저장) startpoint = Properties.Settings.Default.WindowLocation;
                    Form_PriceSearch.form.Location = startpoint;
                    StartLocationChanged(Form_PriceSearch.form, X, Y);
                    Form_PriceSearch.form.Show();

                    Form_PriceSearch.form.CB_레이아웃고정_대금탐색.Checked = Properties.Settings.Default.CB_레이아웃고정_대금탐색;
                ...
                {
                    Properties.Settings.Default.CB_레이아웃고정_대금탐색 = Form_PriceSearch.form.CB_레이아웃고정_대금탐색.Checked;
                    Properties.Settings.Default.CB_대금탐색_시작위치저장 = Form_PriceSearch.form.CB_대금탐색_시작위치저장.Checked;
                    if (Properties.Settings.Default.CB_대금탐색_시작위치저장) Properties.Settings.Default.WindowLocation = Form_PriceSearch.form.Location;
                    Form1.FormPriceSearch_Open = false;
                    Form_PriceSearch.form.Close();
                }
            }
            ...
            if (sender.Equals(Form1.form1.CB_매매그룹))
            {
                if (CB.Checked)
                {
                    ...
                    Form_TradeGroup.form.CB_매매그룹_시작위치저장.Checked = Properties.Settings.Default.CB_매매그룹_시작위치저장;
                    if (Properties.Settings.Default.CB_매매그룹_시작위치저장) startpoint = Properties.Settings.Default.WindowLocation;
                    Form_TradeGroup.form.Location = startpoint;
                    StartLocationChanged(Form_TradeGroup.form, X, Y);
                    Form_TradeGroup.form.Show();

                    Form_TradeGroup.form.CB_레이아웃고정_매매그룹.Checked = Properties.Settings.Default.CB_레이아웃고정_매매그룹;
                ...
                {
                    Properties.Settings.Default.CB_레이아웃고정_매매그룹 = Form_TradeGroup.form.CB_레이아웃고정_매매그룹.Checked;
                    Properties.Settings.Default.CB_매매그룹_시작위치저장 = Form_TradeGroup.form.CB_매매그룹_시작위치저장.Checked;
                    if (Properties.Settings.Default.CB_매매그룹_시작위치저장) Properties.Settings.Default.WindowLocation = Form_TradeGroup.form.Location;
                    Form1.FormTradeGroup_Open = false;
                    Form_TradeGroup.form.Close();
                }
            }
            ...
            if (sender.Equals(Form1.form1.CB_기능설정))
            {
                if (CB.Checked)
                {
                    ...
                    Form_Function.form.CB_기능설정_시작위치저장.Checked = Properties.Settings.Default.CB_기능설정_시작위치저장;
                    if (Properties.Settings.Default.CB_기능설정_시작위치저장) startpoint = Properties.Settings.Default.WindowLocation;
                    Form_Function.form.Location = startpoint;
                    StartLocationChanged(Form_Function.form, X, Y);
                    Form_Function.form.Show();

                    Form_Function.form.CB_레이아웃고정_기능설정.Checked = Properties.Settings.Default.CB_레이아웃고정_대금탐색;
                ...
                {
                    Properties.Settings.Default.CB_레이아웃고정_대금탐색 = Form_Function.form.CB_레이아웃고정_기능설정.Checked;
                    Properties.Settings.Default.CB_기능설정_시작위치저장 = Form_Function.form.CB_기능설정_시작위치저장.Checked;
                    if (Properties.Settings.Default.CB_기능설정_시작위치저장) Properties.Settings.Default.WindowLocation = Form_Function.form.Location;
                    Form1.form1.TopMost = Properties.Settings.Default.CB_지니_64항상위에;
                    Form1.FormFunction_Open = false;
                    Form_Function.form.Close();
                }
            }
        }
        ...
        public static void CB_미니시계_CheckedChanged(object sender)
        {
            ...
            {
                if (Form1.form1.tab_잔고.SelectedIndex == 2) Form1.form1.tab_잔고.SelectedIndex = 0;
                Form1.form1.label_date.BringToFront();
                Form1.form1.label_time.BringToFront();
                Form1.form1.label_date.Show();
                Form1.form1.label_time.Show();
            }
            else
            {
                Form1.form1.label_date.Hide();
                Form1.form1.label_time.Hide();
                Form1.form1.label_date.SendToBack();
                Form1.form1.label_time.SendToBack();
            }
        }
        ...
        public static void CB_종목비공개_CheckedChanged(object sender)
        {
            ...
            if (CB.Checked)
            {
                ...
                if (Form1.form1.CB_계좌비공개.Checked)
                {
                    Form1.form1.종목감추기7.Show();
            ...
            {
                Form1.form1.종목감추기_잔고.Hide();
                Form_Outstanding.form.종목감추기_미체결.Hide();
                Form_Conclusion.form.종목감추기_체결.Hide();
                Form1.form1.종목감추기_로그.Hide();
                Form_JuMun.form.종목감추기_주문.Hide();
                Form1.form1.종목감추기6.Hide();
                Form1.form1.종목감추기7.Hide();
            }
        }

        public static void CB_계좌비공개_CheckedChanged(object sender)
        {
            Form1.form1.Form_Top_Most();
            CheckBox CB = (sender as CheckBox);
            Form1.form1.체크박스_비프(sender);
            ...
            {
                if (Form1.form1.tab_잔고.SelectedIndex == 2) Form1.form1.tab_잔고.SelectedIndex = 0;
                if (Properties.Settings.Default.account_comboBox.Length > 0) Form1.form1.계좌감추기1.Text = "******" + Properties.Settings.Default.account_comboBox.Substring(6);
                if (Form1.form1.account_comboBox.Text.Trim().Length > 0) Form1.form1.계좌감추기1.Text = "******" + Form1.form1.account_comboBox.Text.Substring(6);

                Form1.form1.계좌감추기1.Show();
                Form1.form1.label_Search.Show();
                Form1.form1.CBB_SearchCondition.Show();
                Form1.form1.P_Search_List.Show();

                Form1.form1.계좌감추기1.BringToFront();
                Form1.form1.CBB_SearchCondition.BringToFront();
                Form1.form1.P_Search_List.BringToFront();
                Form1.form1.label_Search.BringToFront();
                ...
                Form1.form1.CBB_SearchCondition.Items.Add(Properties.Settings.Default.CBB_SearchCondition.Trim());
                Form1.form1.CBB_SearchCondition.SelectedItem = Properties.Settings.Default.CBB_SearchCondition.Trim();

                Form1.form1.TB_p_ratio_use.Hide();
                Form1.form1.TB_p_go_use.Hide();
                Form1.form1.TB_p_down_use.Hide();
                Form1.form1.TB_q_ratio_use.Hide();
                Form1.form1.TB_q_go_use.Hide();
                Form1.form1.TB_q_down_use.Hide();
                Form1.form1.combo_p_ratio_UD.Hide();
                Form1.form1.combo_p_go_UD.Hide();
                Form1.form1.combo_p_down_UD.Hide();
                Form1.form1.combo_q_ratio_UD.Hide();
                Form1.form1.combo_q_go_UD.Hide();
                Form1.form1.combo_q_down_UD.Hide();
                Form1.form1.combo_p_ratio.Hide();
                Form1.form1.combo_p_go.Hide();
                Form1.form1.combo_p_down.Hide();
                Form1.form1.combo_q_ratio.Hide();
                Form1.form1.combo_q_go.Hide();
                Form1.form1.combo_q_down.Hide();
            }
            else
            {
                Form1.form1.계좌감추기1.Hide();
                Form1.form1.label_Search.Hide();
                Form1.form1.CBB_SearchCondition.Hide();
                Form1.form1.P_Search_List.Hide();
                Form1.form1.종목감추기7.Hide();

                Form1.form1.combo_p_ratio_UD.BringToFront();
                Form1.form1.combo_p_go_UD.BringToFront();
                Form1.form1.combo_p_down_UD.BringToFront();
                Form1.form1.combo_q_ratio_UD.BringToFront();
                Form1.form1.combo_q_go_UD.BringToFront();
                Form1.form1.combo_q_down_UD.BringToFront();

                Form1.form1.combo_p_ratio.BringToFront();
                Form1.form1.combo_p_go.BringToFront();
                Form1.form1.combo_p_down.BringToFront();
                Form1.form1.combo_q_ratio.BringToFront();
                Form1.form1.combo_q_go.BringToFront();
                Form1.form1.combo_q_down.BringToFront();

                Form1.form1.TB_p_ratio_use.BringToFront();
                Form1.form1.TB_p_go_use.BringToFront();
                Form1.form1.TB_p_down_use.BringToFront();
                Form1.form1.TB_q_ratio_use.BringToFront();
                Form1.form1.TB_q_go_use.BringToFront();
                Form1.form1.TB_q_down_use.BringToFront();

                Form1.form1.TB_p_ratio_use.Show();
                Form1.form1.TB_p_go_use.Show();
                Form1.form1.TB_p_down_use.Show();
                Form1.form1.TB_q_ratio_use.Show();
                Form1.form1.TB_q_go_use.Show();
                Form1.form1.TB_q_down_use.Show();
                Form1.form1.combo_p_ratio_UD.Show();
                Form1.form1.combo_p_go_UD.Show();
                Form1.form1.combo_p_down_UD.Show();
                Form1.form1.combo_q_ratio_UD.Show();
                Form1.form1.combo_q_go_UD.Show();
                Form1.form1.combo_q_down_UD.Show();
                Form1.form1.combo_p_ratio.Show();
                Form1.form1.combo_p_go.Show();
                Form1.form1.combo_p_down.Show();
                Form1.form1.combo_q_ratio.Show();
                Form1.form1.combo_q_go.Show();
                Form1.form1.combo_q_down.Show();
            }
        }
